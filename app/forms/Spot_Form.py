...
class NewSpotForm(FlaskForm):
    ...
    lng = FloatField('Longitude', validators=[DataRequired("Please provide the longitude of your listing."), NumberRange(-180, 80, "Minimum longitude is -180 and Maximum is 80.")])
    ...
    price = IntegerField('Price', validators=[DataRequired("Please provide a price per night."), NumberRange(10, 10000, "Price per night must be between $25 and $10,000")])
